...
function com_uninstall(){
	...
	if (JFolder::exists(dirname($installer->getPath('extension_site')).DS.'..'.DS.'plugins'.DS.'editors'))
	{
		...
		{
			unlink(dirname($installer->getPath('extension_site')).DS.'..'.DS.'plugins'.DS.'editors'.DS.'ckeditor.php');
			unlink(dirname($installer->getPath('extension_site')).DS.'..'.DS.'plugins'.DS.'editors'.DS.'ckeditor.xml');
