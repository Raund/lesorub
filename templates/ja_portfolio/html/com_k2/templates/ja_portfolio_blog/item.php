...
<div id="k2Container" class="itemView<?php echo ($this->item->featured) ? ' itemIsFeatured' : ''; ?><?php if($this->item->params->get('pageclass_sfx')) echo ' '.$this->item->params->get('pageclass_sfx'); ?>">
	...
	<div id="k2Container-inner" class="clearfix">
  ...
  <div class="itemBody">
		...
		<?php if($this->item->params->get('itemAuthorBlock')) : ?>
	  <div class="catItemAuthor">
				<strong><?php echo JText::_('Author:'); ?></strong> <a href="<?php echo $this->item->author->link; ?>"><?php echo $this->item->author->name; ?></a>
		</div>
	  <?php endif; ?>
  ...
  <?php if(!JRequest::getInt('print') && file_exists(JPATH_SITE.DS.'components'.DS.'com_jacomment'.DS.'jacomment.php') && file_exists(JPATH_SITE.DS.'plugins'.DS.'system'.DS.'jacomment.php')){
		...
		if(!preg_match($_jacCode, $this->item->fulltext) && !preg_match($_jacCodeDisable, $this->item->fulltext) && !preg_match($_jacCodeDisableid, $this->item->fulltext)) {	
