...
<div id="k2Container" class="itemListView<?php if($this->params->get('pageclass_sfx')) echo ' '.$this->params->get('pageclass_sfx'); ?>">
	...
	<div class="itemListCategoriesBlock">
		...
		<div class="itemListSubCategories">
			<?php //echo JText::_('Children categories'); ?>

			<?php 
			// Define a CSS class for the last container on each row
			$counter = 0;
			foreach($this->subCategories as $key=>$subCategory):
				$counter = ($counter == $this->params->get('subCatColumns')) ? 1:$counter+1;
				$cls = ($counter == 1)?'col-first':(($counter == $this->params->get('subCatColumns'))?'col-last':'col-center');	
			?>
			<div class="subCategoryContainer <?php echo $cls ?> clearfix" style="width:<?php echo number_format(100/$this->params->get('subCatColumns'), 1); ?>%;">
