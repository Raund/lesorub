		...
		<div class="userItemView<?php if(!$item->published || ($item->publish_up != $this->nullDate && $item->publish_up > $this->now) || ($item->publish_down != $this->nullDate && $item->publish_down < $this->now)) echo ' userItemViewUnpublished'; ?><?php echo ($item->featured) ? ' userItemIsFeatured' : ''; ?>">
		  ...
		  <div class="article-tools clearfix">
		  	<dl class="article-info">
					...
					<!-- Date created -->
					<dd class="create">
						<strong><?php echo JText::_("Post date"); ?>: </strong><?php echo JHTML::_('date', $item->created , JText::_('DATE_FORMAT_LC3')); ?>
					</dd>
					<?php endif; ?>
		  ...
		  <div class="userItemBody">
			  ...
			  <!-- Item introtext -->
			  <div class="userItemIntroText clearfix">
			...
			<!-- Item "read more..." link -->
			<p class="readmore">
				<a href="<?php echo $item->link; ?>"><?php echo JText::_('Read more...'); ?></a>
			</p>
			<?php endif; ?>
