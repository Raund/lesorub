...
var JAT3_PAGEIDSETTINGS = new Class({	
	...
	addrow: function (obj) {
		...
		last.getElement('span.pageid_text').addEvent('click', this.choosePageids.bind(this, args));
		
		var args = new Array(last.getElement('span.profile_text'), k);
		last.getElement('span.profile_text').addEvent('click', this.add_chooseProfile.bind(this, args));
