...
<dl class="article-info" <?php if (!($this->item->params->get('show_pdf_icon') || $this->item->params->get('show_print_icon') || $this->item->params->get('show_email_icon'))):?>style="width: 100%"<?php endif;?>>
	...
	<?php if ($this->item->params->get('show_create_date')) : ?>
		<dd class="create">
			<?php $created = T3Hook::_('t3_date_format', array($this->item->created, 'section.blog.created'));
...
<p class="readmore">
	<a href="<?php echo $this->escape($this->item->readmore_link); ?>" title="<?php echo $this->escape($this->item->title); ?>">
