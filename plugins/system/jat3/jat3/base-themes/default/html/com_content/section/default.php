...
<div class="category-desc<?php echo $this->escape($this->params->get('pageclass_sfx')); ?>">
...
<ul>
	<?php foreach ($this->categories as $category) :
		...
		<li>
			<span class="jitem-title"><a href="<?php echo $category->link; ?>"><?php echo $this->escape($category->title); ?></a></span>
